...
class Person(models.Model):
	...
	class Meta:
        ...
        db_table = 'reporting_queries_Person'
...
class PostalAddress(models.Model):
	...
	class Meta:
        app_label = 'reporting_queries'
        db_table = 'reporting_queries_PostalAddress'
...
class PersonPostalAddress(models.Model):
	...
	class Meta:
        app_label = 'reporting_queries'
        db_table = 'reporting_queries_PersonPostalAddress'
...
class PersonEmailAddress(models.Model):
	...
	class Meta:
        app_label = 'reporting_queries'
        db_table = 'reporting_queries_PersonEmailAddress'
...
class PhoneNumber(models.Model):
	...
	class Meta:
        app_label = 'reporting_queries'
        db_table = 'reporting_queries_PhoneNumber'
...
class PersonPhoneNumber(models.Model):
	...
	class Meta:
        app_label = 'reporting_queries'
        db_table = 'reporting_queries_PersonPhoneNumber'
...
class Profile(models.Model):
	...
	class Meta:
        app_label = 'reporting_queries'
        db_table = 'reporting_queries_Profile'
